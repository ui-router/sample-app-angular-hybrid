...
const messageState = {
  ...
  resolve: {
    ...
    message: ['Messages', '$stateParams', (Messages, $stateParams) => {
    ...
    nextMessageGetter: ['MessageListUI', 'messages', (MessageListUI, messages) => {
...
const messageListState = {
  ...
  resolve: {
    ...
    folder: ['Folders', '$stateParams', (Folders, $stateParams) => {
    ...
    messages: ['Messages', 'folder', (Messages, folder) => {
